...
namespace UltEvents.Editor
{
    ...
    public sealed class DrawerState
    {
        ...
        public void BeginCall(SerializedProperty callProperty)
        {
            ...
            IdProperty = GetCallIdProperty(callProperty);
        ...
        public static SerializedProperty GetCallIdProperty(SerializedProperty callProperty)
            => callProperty.FindPropertyRelative(Names.PersistentCall.Id);
