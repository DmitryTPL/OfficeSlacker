...
namespace UltEvents.Editor
{
    ...
    public class UltEventDrawer : PropertyDrawer
    {
        ...
        protected static ReorderableList _CurrentCallList;
        protected static int _CurrentCallCount;

        protected virtual bool IsReorderableListDraggable { get; set; } = true;
        ...
        public readonly Dictionary<string, ReorderableList>
            PropertyPathToList = new();

        protected void CachePersistentCallList(SerializedProperty eventProperty)
        {
            ...
            if (!PropertyPathToList.TryGetValue(path, out _CurrentCallList))
            {
                ...
                _CurrentCallList = new(eventProperty.serializedObject, eventProperty, true, true, true, true)
                {
                    ...
                    draggable = IsReorderableListDraggable
                };
        ...
        protected virtual void AddNewCall(ReorderableList list, Object target, string id = null)
        {
            ...
            PersistentCallDrawer.SetId(string.IsNullOrEmpty(id) ? Guid.NewGuid().ToString() : id);
            PersistentCallDrawer.SetTarget(target);
            PersistentCallDrawer.SetEnable(true);
            DrawerState.Current.EndCall();
        }

        /************************************************************************************************************************/

        protected virtual void RemoveCall(ReorderableList list, int index)
        {
